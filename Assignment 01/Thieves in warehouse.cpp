    ...
    Item items[], int n, double W)
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        if (W > 0 && items[i].w > 0)
        {
            ...
            if (items[i].w <= W)
            {
                cout << "Taking " << items[i].id << ":  " << items[i].w << ".0 kg " << items[i].perKgV * items[i].w << ".0 taka" << endl;
            ...
            else
            {
                ...
                cout << "Taking " << items[i].id << ":  " << rem << ".0 kg " << rem * items[i].perKgV << ".0 taka" << endl;
                items[i].w -= W;
                W = 0;
            }
        }
...
int main()
{
    ...
    for (int i = 0; i < k; i++)
    {
        ...
        cout << "Thief " << i + 1 << "  profit: " << profit << ".0 taka" << endl << endl;
        if (profit > 0)
        {
            cnt++;
        }
    ...
    if (items[n - 1].w > 0)
    {
        ...
        for (int i = 0; i < n; i++)
        {
            if (items[i].w > 0)
            {
                ...
                cout << items[i].id << ":  " << items[i].w << ".0 kg " << items[i].w * items[i].perKgV << "0. taka" << endl;
            }
        }
        cout << endl;
    }
